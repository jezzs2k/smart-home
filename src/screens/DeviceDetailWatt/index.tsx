...
({onCloseLoading, onSetLoading}: DeviceDetailsProps) => {
    ...
    const [dataWatt, setDataWatt] = useState([
        0,0,0,0,0,0,0
    ]);
    ...
    const [m15E, setm15E] = useState(
        0
    );
    const [h1E, seth1E] = useState(
        0
    );
    const [h6E, seth6E] = useState(
        0
    );
    const [h12E, seth12E] = useState(
        0
    );
    const [h24E, seth24E] = useState(
        0
    );
    const [w1E, setw1E] = useState(
        0
    );
    const [M1E, setM1E] = useState(
        0
    );
        ...
        <View style={styles.header}>
            <View style={styles.headerLeft}>
                ...
                <Progress.Circle 
                    ...
                    formatText={(process) => {
                        return <Text style={[styles.textMid, styles.textBold]}>{dataEnergy?.energytage ?? '0'} W</Text>
                    }}
                />
            </View>
